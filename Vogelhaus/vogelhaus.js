...
(function (Vogelhaus) {
    ...
    function handleLoad(_event) {
        ...
        drawTrees(new Vogelhaus.Vector(700, 600), new Vogelhaus.Vector(200, 250));
    ...
    function drawTrees(_position, _size) {
        ...
        for (let drawn = 0; drawn < nTrees; drawn++) {
            ...
            Vogelhaus.crc2.fillRect(x, y, 20, 30);
            Vogelhaus.crc2.fillStyle = colorCrown;
            Vogelhaus.crc2.beginPath();
            Vogelhaus.crc2.moveTo(x + 40, y);
            Vogelhaus.crc2.lineTo(x - 20, y);
            Vogelhaus.crc2.lineTo(x + 10, y - 60);
            Vogelhaus.crc2.closePath();
            Vogelhaus.crc2.fill();
            Vogelhaus.crc2.restore();
        }
